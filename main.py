...
class OWL():
    ...
    async def screen12(self):
        try:
            await self.rpc.update(state="Contact & Info Screen", details="Spammer", large_image="default")
        except:
            pass
        clear()
        ...
        print(
            ...
            'Info: Hello User, This is lorenzohappy Spammer, a new spammer for discord. This tool is for spamming discord\'s api and troll servers/users. We want this to be famous and yeah, hope you like it <3.'
        )
        print(" ")
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
    ...
    def exit(self):
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
                  Fore.CYAN + "Thank you for using lorenzohappy19 Spammer")
        exit()
